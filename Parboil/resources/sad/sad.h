...
#define SAD_TYPE_IX(n, image_size) \
  ((n == 1) ? SAD_TYPE_1_IX(image_size) : ((n == 2) ? SAD_TYPE_2_IX(image_size) : ((n == 3) ? SAD_TYPE_3_IX(image_size) : ((n == 4) ? SAD_TYPE_4_IX(image_size) : ((n == 5) ? SAD_TYPE_5_IX(image_size) : ((n == 6) ? SAD_TYPE_6_IX(image_size) : (SAD_TYPE_7_IX(image_size))))))))
...
#define SAD_TYPE_CT(n) \
  ((n == 1) ? SAD_TYPE_1_CT : ((n == 2) ? SAD_TYPE_2_CT : ((n == 3) ? SAD_TYPE_3_CT : ((n == 4) ? SAD_TYPE_4_CT : ((n == 5) ? SAD_TYPE_5_CT : ((n == 6) ? SAD_TYPE_6_CT : (SAD_TYPE_7_CT)))))))
